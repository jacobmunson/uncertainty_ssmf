...
#
# Pulled from https://github.com/kokikwbt/ssmf/tree/main?tab=readme-ov-file with minor edits.
#
# input: 
...
import sys, time
#print(">>> ENTERING ncp.ncp", flush=True)
t0 = time.time()
...
def ncp(M, r, tol=1e-4, maxit=500, maxT=1e+6, rw=1, verbose=False):
    ...
    for k in range(maxit):
        ...
        if obj >= obj0:
            ...
            t0 = t
            obj0 = obj
        print(f">>> NCP took {time.time()-time0:.3f}s", flush=True)
